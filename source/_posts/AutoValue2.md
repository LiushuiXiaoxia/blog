---
title: 安利AutoValue第二波
date: 2017-04-18 19:39:45
categories: Libs
tags:
    - AutoValue
---
...
前面介绍了如何使用AutoValue如何使用, 参见这里[Android Model正确使用姿势——AutoValue](https://github.com/LiushuiXiaoxia/AutoValueDemo) ，如果喜欢或者决定使用AutoValue的小伙伴是不是迫不及待打算开始使用。
...
![](https://raw.githubusercontent.com/LiushuiXiaoxia/AutoValueConvert/master/doc/1.gif)
